...
# --- Configuration ---
PROJECT_NAME="ece-suite"
REPO_NAME="ece-suite" # CHANGE THIS if your GitHub repo name is different!

echo "🚀 Starting ECE Suite Setup for GitHub Codespaces..."

# 1. Create Vite Project
echo "📦 Scaffolding Vite project..."
npm create vite@latest "$PROJECT_NAME" -- --template react

cd "$PROJECT_NAME"

# 2. Install Dependencies
echo "⬇️ Installing standard dependencies..."
npm install

echo "⬇️ Installing UI and Deployment dependencies..."
...
# 4. Inject App Code (Using quoted heredoc to preserve React syntax)
echo "💻 Writing App.jsx application code..."
cat <<'EOF' > src/App.jsx
...
# 5. Configure Vite and NPM Scripts
...
echo "👉 To deploy to GitHub:       Refer to GUIDE.md"
echo "----------------------------------------------------"